...
DEFAULT_MODELS_ROOT = os.environ.get(
    ...
    r"D:\data\models" if IS_WINDOWS else str(Path.home() / "data" / "models"),
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Root folder path for model files "
            f"(default: {DEFAULT_MODELS_ROOT}; override with OPENVINO_MODELS_ROOT)."
        ),
    )
    parser.add_argument(
        "--build-type",
